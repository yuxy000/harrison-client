...
import HealthCertificateBack from '@/components/HealthCertificateBack'
...
export default new Router({
  routes: [
    ...
    {
      path: '/health-certificate-back',
      name: 'HealthCertificateBack',
      component: HealthCertificateBack
    },
    {
      path: '/login',
      name: 'Login',
